...
namespace ResortERP.Core.VM
{
    public class CustomersVM
    {
        ...
        public string CUST_PHOTO_Str { get; set; }
        ...
        public string Cust_Photo_Base64 { get; set; }
        public AccountVM Account { get; set; }
        public string AccountTypeARName { get; set; }
        public CurrencyVM currency { get; set; }
        public CustomerBranchesVM customerBranches { get; set; }
