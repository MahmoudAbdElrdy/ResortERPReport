...
var clipSetting = {}, appSetting = {};
	...
	var settingsHandler = function() {
		...
		$('#skin_color').attr("href", "../Content/assetsEn/css/themes/" + appSetting.theme + ".css");
		...
		$('input[name="setting-theme"]').change(function() {
			...
			$('#skin_color').attr("href", "../Content/assetsEn/css/themes/" + selectedTheme + ".css");
		...
		function switchLogo(theme) {
			...
			case "theme-5":
			case "theme-6":
				$(".navbar-brand img").attr("src", "../Content/assetsEn/images/logo2.png");
				break;

			default:
				$(".navbar-brand img").attr("src", "../Content/assetsEn/images/logo.png");
				break;
			}
		}
	...
	$('#reset-layout').on('click', function() {
		...
		$('#skin_color').attr("href", "../Content/assetsEn/css/themes/lyt2-theme-1.css");
		switcheryHandler();
		settingsHandler();
		setTimeout(function() {
