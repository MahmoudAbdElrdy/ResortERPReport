...
var clipSetting = {}, appSetting = {};
	...
	var settingsHandler = function() {
		...
		$('#skin_color').attr("href", "../Content/assets/css/themes/" + appSetting.theme + ".css");
		...
		$('input[name="setting-theme"]').change(function() {
			...
			$('#skin_color').attr("href", "../Content/assets/css/themes/" + selectedTheme + ".css");
		...
		function switchLogo(theme) {
			...
			case "theme-5":
			case "theme-6":
				$(".navbar-brand img").attr("src", "../Content/assets/images/logo2.png");
				break;

			default:
				$(".navbar-brand img").attr("src", "../Content/assets/images/logo4.png");
				break;
			}
		}
	...
	$('#reset-layout').on('click', function() {
		...
		$('#skin_color').attr("href", "../Content/assets/css/themes/lyt2-theme-7.css");
		switcheryHandler();
		settingsHandler();
		setTimeout(function() {
