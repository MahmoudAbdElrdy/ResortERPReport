...
app.controller('GoldBoxMotionController', ['$scope', '$rootScope', '$location', '$log', '$q', 'accountsService', 'dateFilter', '$filter', 'commonService', 'currencyService', '$base64', 'entryService', 'accountStatementService', 'compBranchesService', function ($scope, $rootScope, $location, $log, $q, accountsService, dateFilter, $filter, commonService, currencyService, $base64, entryService, accountStatementService, compBranchesService) {
    ...
    $scope.fnExcelReport = function () {
        ...
        var x1 = "حركة صندوق الذهب المشغول (سندات )".split(" ").reverse().join(" ");
