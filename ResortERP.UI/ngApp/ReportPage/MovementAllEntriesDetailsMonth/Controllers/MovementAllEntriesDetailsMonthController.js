...
app.controller('movementAllEntriesDetailsMonthController', ['$scope', '$rootScope', '$location', '$log', '$q', 'accountsService', 'dateFilter', '$filter', 'commonService', 'currencyService', '$base64', 'entryService', 'accountStatementDailyService','compBranchesService', function ($scope, $rootScope, $location, $log, $q, accountsService, dateFilter, $filter, commonService, currencyService, $base64, entryService, accountStatementDailyService, compBranchesService) {
    ...
    $scope.movementAllEntriesDetailsMonthPageLoad = function () {
    ...
    $scope.GetSearchResult = function () {
        if ($scope.var.ACC_ID && $scope.startDate && $scope.endDate && $scope.SelectedBranch.length > 0) {
            ...
            var ReportName = "GetEntriesDetailsMonthly";
