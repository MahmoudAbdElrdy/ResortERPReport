...
app.controller('purchasesDetailsDailyController', ['$scope', '$rootScope', '$location', '$log', '$q', 'accountsService', 'dateFilter', '$filter', 'commonService', 'currencyService', '$base64', 'entryService', 'accountStatementDailyService','compBranchesService', function ($scope, $rootScope, $location, $log, $q, accountsService, dateFilter, $filter, commonService, currencyService, $base64, entryService, accountStatementDailyService, compBranchesService) {
    ...
    $scope.purchasesDetailsDailyPageLoad = function () {
    ...
    $scope.GetSearchResult = function () {
        if ( $scope.startDate && $scope.endDate && $scope.SelectedBranch.length > 0) {
            ...
            var ReportName = "PurchasesDetailsDailyReport";
