...
app.controller('RiyalFundMotionDailyController', ['$scope', '$rootScope', '$location', '$log', '$q', 'accountsService', 'dateFilter', '$filter', 'commonService', 'currencyService', '$base64', 'entryService', 'accountStatementDailyService','compBranchesService', function ($scope, $rootScope, $location, $log, $q, accountsService, dateFilter, $filter, commonService, currencyService, $base64, entryService, accountStatementDailyService, compBranchesService) {
    ...
    $scope.GetSearchResult = function () {        
        ...
        if ($scope.var.ACC_ID && $scope.startDate && $scope.SelectedBranch.length > 0) {
            ...
            accountStatementDailyService.getReportResult(companyBranches, Accounts, date).then(function (results) {
    ...
    $scope.fnExcelReport = function () {
        ...
        var x1 = "حركة صندوق الريال (يومية )".split(" ").reverse().join(" ");
